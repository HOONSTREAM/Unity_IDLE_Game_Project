...
public class Spitfire_Skill : Skill_Base
{
    [SerializeField]
    private GameObject Player_Effect;

    private const float SKILL_DAMAGE_MULTIPLE_CONSTATNT = 4.5f;
    private float LifeTime = 3.0f;
    private GameObject Spitfire_Skill_Effect;
    public override void Set_Skill()
    {
        ...
        {
            Spitfire_Skill_Effect = Instantiate(Resources.Load<GameObject>("Prefabs/Spitfire_Skill_Effect"));
            Destroy(Spitfire_Skill_Effect, LifeTime);
        }
    ...
    IEnumerator Set_Skill_Coroutine()
    {
        try
        {
            ...
            if (!Utils.is_Skill_Effect_Save_Mode && Spitfire_Skill_Effect != null)
            {
                Spitfire_Skill_Effect.transform.position = Vector3.zero;
            }
        ...
        finally
        {
            ...
            Debug.Log("[Spitfire_Skill] ReturnSkill ½ÇÇàµÊ");
            ReturnSkill();
        }
    }
}
